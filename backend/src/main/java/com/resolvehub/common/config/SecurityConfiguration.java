...
public class SecurityConfiguration {
    ...
    private final String allowedCorsOriginsRaw;
    ...
    public SecurityConfiguration(
            ...
            String allowedCorsOriginsRaw
    ) {
        this.jwtAuthenticationFilter = jwtAuthenticationFilter;
        this.userDetailsService = userDetailsService;
        this.environment = environment;
        this.allowedCorsOriginsRaw = allowedCorsOriginsRaw;
    }
    ...
    private List<String> normalizedAllowedOrigins() {
        List<String> configuredOrigins = Stream.of(allowedCorsOriginsRaw.split(","))
                .map(String::trim)
